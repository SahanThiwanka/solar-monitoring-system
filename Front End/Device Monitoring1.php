...
<body onload="javascript:hideTable2(); javascript:hideTable3()">
                                ...
                                <table id="order_table" class="table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['pv_Length']; ?></td>
                                            <td><?php echo $row['pv_NOM']; ?></td>
                                            <td><?php echo $row['pv_id_1']; ?></td>
                                            <td><?php echo $row['pv_DC_current_1']; ?>&nbsp; A</td>
                                            <td><?php echo $row['pv_DC_voltage_1']; ?>&nbsp;V </td>
                                            <td><?php echo $row['pv_DC_power_1']; ?>&nbsp;W </td>
                                        </tr>	
                                        <?php
                                        }
                                        ?>
